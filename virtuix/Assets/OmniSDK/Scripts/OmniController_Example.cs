...
public class OmniController_Example : MonoBehaviour {
    ...
    void Update ()
    {
        if(!RotationCorrected)
        {
            ...
            if(isDisplayPresent == true) {        // This line replaces the existing if statements, although the one in “OmniMovementComponent.cs” “== false” and the one in "OmniController_Example.cs" should be “== true”
                CorrectSpawnForward();
            }
        }
